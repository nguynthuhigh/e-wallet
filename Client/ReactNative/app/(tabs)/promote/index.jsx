...
const PromotionPage = () => {
  ...
  useEffect(() => {
    ...
    const updatePlaceholder = () => {
      if (forward) {
        ...
        if (index === text.length) {
          forward = false;
          setTimeout(updatePlaceholder, 600);
          return;
        }
      } else {
    ...
    const timeoutId = setTimeout(updatePlaceholder, 50);
        ...
        <ScrollView>
          <View className="flex-1 h-20 px-4 flex-row mt-5">
            <TouchableOpacity
              ...
              className="w-[50%] bg-white flex-1 rounded-3xl shadow-md"
            >
            ...
            <TouchableOpacity
              activeOpacity={0.7}
              className="w-[50%] bg-white flex-1 rounded-3xl shadow-md"
              onPress={() => router.navigate("/promote/my-gift")}
            >
              <View className="flex-row items-center flex-1 px-5">
