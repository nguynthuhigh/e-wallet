      ...
      <View>
          ...
          <View className="bg-white h-[312px] mt-[30px] px-[11px] rounded-[15px] rounded-b-none">
            <View className="flex-row items-center border-[#5AAA67] border-[1px] rounded-[15px]  h-[67] mt-[11px] ">
              ...
              <View className="ml-[8px]">
                ...
                <Text className="font-bold text-[22px]">-30.000đ</Text>
              </View>
            </View>
            <View>
            ...
            <View>
              <View className=" flex-row items-center justify-between">
                ...
                <Text className="font-bold  text-[15px] ">22022004</Text>
              </View>
              <View className=" flex-row items-center justify-between">
                <Text className="font-bold  text-[15px] mb-[15]  text-[#757575]">
                  Tài khoản thẻ
                </Text>
                <Text className="font-bold mb-[15] text-[15px] ">Ví PayEx</Text>
              </View>
              <View className=" flex-row items-center justify-between">
                <Text className="font-bold  text-[15px]  text-[#757575]">
                  Tổng phí
                </Text>
                <Text className="font-bold  text-[15px] ">Miễn phí</Text>
              </View>
            </View>
          </View>
        ...
        <View className="bg-white h-[130px] mt-[20px] mx-[17px] rounded-[15px]">
          <View className="mt-[15px] mx-[11px] flex-col justify-between">
            <Item_Title title={"Tên Ví Pay Express"} content={"123"}>
              {" "}
            </Item_Title>
            <Item_Title title={"Tên gợi nhớ"} content={"123"}>
              {" "}
            </Item_Title>
...
const Item_Title = ({ ...props }) => {
  return (
    <View className="flex-row items-center justify-between mt-[13px]">
      <Text className=" font-bold  text-[15px]  text-[#757575]">
        {props.title}
      </Text>
      <Text className="font-bold  text-[15px] ">{props.content}</Text>
    </View>
  );
};
