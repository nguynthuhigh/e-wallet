    ...
    <View>
      ...
      <SafeAreaView className="absolute top-7">
        ...
        <ScrollView className="px-5">
          <View className="w-full h-9 mt-5 flex-row">
            <View className="w-[85%] h-full bg-white mr-3 flex-row items-center rounded-3xl px-2">
            ...
            <View className="w-[15%] h-full bg-white flex-1 rounded-lg items-center justify-center">
