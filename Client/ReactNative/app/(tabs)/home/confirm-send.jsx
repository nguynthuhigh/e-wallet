...
const Wallet = () => {
  return (
    <TouchableOpacity className="w-[30%] h-[55px] bg-[#FFF5F5] rounded-xl flex-row items-center">
      ...
      ></Image>
      <View>
        <Text className="text-[16px] font-semibold ">VND</Text>
      ...
      <SafeAreaView className="absolute top-7">
        ...
        <ScrollView className="px-5">
          ...
          <TouchableOpacity
            ...
            className="bg-[#0D99FF] rounded-xl p-2 mt-4"
          >
            {!isLoading ? (
              ...
              <ActivityIndicator className="h-[40px]"></ActivityIndicator>
            )}
          </TouchableOpacity>
        </ScrollView>
