      ...
      >
        <View className="h-full px-6 mt-2">
          ...
          <View className="mx-auto mt-10">
            <Text className="font-iSemiBold text-white text-[30px] mb-2">
              {formatCurrency(2000, "USD")}
            </Text>
            <Text className="mx-auto text-[17px] text-gray-500">
              ≈{formatCurrency(2000 * 25210, "VND")}
            </Text>
          </View>
